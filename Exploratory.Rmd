...
par(op)
```
These results are likely to be biassed because of the distribution of backgrounds of respondents and this may mean that we should not assume the item responses that were not "don't know" are representative.
